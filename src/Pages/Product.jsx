...
const Product = () => {
  ...
  return (
    <>
      <nav className="navbar fixed-top" data-bs-theme="white" style={{backgroundColor:"#FED8B1"}}>
        <div className="container-fluid">
          ...
          <div className='logoImage' style={{alignItems:'center', justifyContent:'center'}}>
            <img src={logo} alt="Logo" style={{width:'15%', borderRadius:'50px'}}/>
          </div>
          <div className="parent-container">
            <div className="h5">
              <h6><i className="bi bi-person-circle"></i>  {uname}</h6>
            </div>
          </div>
        </div>
      </nav>
